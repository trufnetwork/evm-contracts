...
export const registerRolesTasks = (scope: ConfigurableScopeDefinition) => {
  scope
    .task("grantRole", "Grants a role to a specified address")
  ...
  scope
    .task("revokeRole", "Revokes a role from a specified address")
    .addParam("contract", "The TNOracleV1 contract address")
  ...
  scope
    .task("grantReader", "Grants READER_ROLE to an address")
    .addParam("contract", "The TNOracleV1 contract address")
  ...
  scope
    .task("renounceRole", "Renounces a role from the caller's address")
    .addParam("contract", "The TNOracleV1 contract address")
    .addParam("role", "The role name (e.g. SOURCE_KEEPER_ROLE)")
