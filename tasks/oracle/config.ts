...
export const registerConfigTasks = (scope: ConfigurableScopeDefinition) => {
  scope
    .task("setDonId", "Sets the DON ID")
  ...
  scope
    .task("setSubscriptionId", "Sets the subscription ID")
    .addParam("contract", "The TNOracleV1 contract address")
  ...
  scope
    .task("setGasLimit", "Sets the gas limit for requests")
    .addParam("contract", "The TNOracleV1 contract address")
  ...
  scope
    .task("setStalePeriod", "Sets the stale period for requests")
    .addParam("contract", "The TNOracleV1 contract address")
  ...
  scope
    .task("getState", "Prints all visible states from the TNOracleV1 contract")
    .addParam("contract", "The TNOracleV1 contract address")
