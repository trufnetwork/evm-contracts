...
task("oracle:setSecretsUrl", "Sets the encrypted secrets URL for the TNOracleV1 contract")
...
task("oracle:clearSecretsUrl", "Clears the encrypted secrets URL from the TNOracleV1 contract")
  .addParam("contract", "The TNOracleV1 contract address")
